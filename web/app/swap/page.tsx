...
export default function Swap() {
  ...
  const connection = new Connection(
    'https://mainnet.helius-rpc.com/?api-key=ec3b681d-994c-4280-89e7-5d495233d6d4'
  );
  ...
  async function getQuote(currentAmount: number) {
    ...
    const quote = await (
      await fetch(
        `https://quote-api.jup.ag/v6/quote?inputMint=So11111111111111111111111111111111111111112&outputMint=EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v&amount=10000000 * Math.pow(10, fromAsset.decimals)}&slippage=0.5`
      )
    ).json();
